...
var _user$project$KOLC$viewCharacter = function (model) {
			...
			A2(
				_elm_lang$core$Basics_ops['++'],
				{
					...
					_0: _evancz$elm_graphics$Collage$toForm(
						A3(_evancz$elm_graphics$Element$image, 60, 100, '/static/advs/img/base.gif')),
					_1: {ctor: '[]'}
				},
				model.equipped ? {
					ctor: '::',
					_0: _evancz$elm_graphics$Collage$toForm(
						A3(_evancz$elm_graphics$Element$image, 60, 100, '/static/advs/img/hat.gif')),
					_1: {ctor: '[]'}
				} : {ctor: '[]'})));
};
var _user$project$KOLC$isMonsterDead = function (m) {
	var _p0 = m;
	if (_p0.ctor === 'Combat') {
		return _elm_lang$core$Native_Utils.eq(_p0._2, 1) ? true : false;
	} else {
		var _p1 = _elm_lang$core$Debug$log('Oops! unexpected Noncombat mode?');
		return true;
	}
};
var _user$project$KOLC$locFromMode = function (mode) {
	var _p2 = mode;
	if (_p2.ctor === 'Combat') {
		return _p2._1;
	} else {
...
var _user$project$KOLC$capCurrency = function (previous) {
	return (_elm_lang$core$Native_Utils.cmp(previous, 0) < 0) ? 0 : previous;
};
var _user$project$KOLC$capHitpoints = function (previous) {
	return (_elm_lang$core$Native_Utils.cmp(previous, 0) < 0) ? 0 : previous;
};
var _user$project$KOLC$capAdventures = function (previous) {
	return (_elm_lang$core$Native_Utils.cmp(previous, 200) > -1) ? 200 : previous;
};
var _user$project$KOLC$makeBody = function (value) {
	return A2(
		_elm_lang$http$Http$stringBody,
		'application/json',
		A2(_elm_lang$core$Json_Encode$encode, 0, value));
};
var _user$project$KOLC$makeValue = function (loc) {
	var locstring = _elm_lang$core$Basics$toString(loc);
	return _elm_lang$core$Json_Encode$object(
		{
			...
			_0: {
				ctor: '_Tuple2',
				_0: 'current_loc',
				_1: _elm_lang$core$Json_Encode$string(locstring)
			},
			_1: {ctor: '[]'}
		});
};
var _user$project$KOLC$damageUrl = 'http://localhost:8000/advs/';
var _user$project$KOLC$decoderTurnDamage = A2(_elm_lang$core$Json_Decode$field, 'damage', _elm_lang$core$Json_Decode$int);
var _user$project$KOLC$Model = F6(
	function (a, b, c, d, e, f) {
		return {equipped: a, allitems: b, adventures: c, mode: d, currency: e, hitpoints: f};
	});
...
var _user$project$KOLC$Noncombat = function (a) {
	return {ctor: 'Noncombat', _0: a};
};
var _user$project$KOLC$Combat = F3(
	function (a, b, c) {
		return {ctor: 'Combat', _0: a, _1: b, _2: c};
	});
var _user$project$KOLC$playerDoesDamage = function (m) {
	var _p3 = m;
	if (_p3.ctor === 'Combat') {
		return A3(_user$project$KOLC$Combat, _p3._0, _p3._1, _p3._2 - 1);
	} else {
		var _p4 = _elm_lang$core$Debug$log('Oops! unexpected Noncombat mode?');
		return _user$project$KOLC$Noncombat(_p3._0);
	}
};
var _user$project$KOLC$startFightWith = F2(
	function (m, who) {
		var _p5 = m;
		if (_p5.ctor === 'Combat') {
			var _p6 = _elm_lang$core$Debug$log('Oops! unexpected combat?');
			return A3(_user$project$KOLC$Combat, _p5._0, _p5._1, _p5._2);
		} else {
			return A3(_user$project$KOLC$Combat, who, _p5._0, 3);
		}
	});
var _user$project$KOLC$TurnDamage = function (a) {
	return {ctor: 'TurnDamage', _0: a};
};
var _user$project$KOLC$takeTurnDamage = F2(
	function (name, hp) {
		return A2(
			_elm_lang$http$Http$send,
			_user$project$KOLC$TurnDamage,
			A3(
				_elm_lang$http$Http$post,
				'http://localhost:8000/advs/turn_damage',
				_user$project$KOLC$makeBody(
				...
				_user$project$KOLC$decoderTurnDamage));
	});
var _user$project$KOLC$Damage = function (a) {
	return {ctor: 'Damage', _0: a};
};
var _user$project$KOLC$takeDamage = function (loc) {
	return A2(
		_elm_lang$http$Http$send,
		_user$project$KOLC$Damage,
		A3(
			_elm_lang$http$Http$post,
			_user$project$KOLC$damageUrl,
			_user$project$KOLC$makeBody(
				_user$project$KOLC$makeValue(loc)),
			_user$project$KOLC$decoderDamage));
};
var _user$project$KOLC$DealDamage = function (a) {
	return {ctor: 'DealDamage', _0: a};
};
var _user$project$KOLC$AdventureLoc = function (a) {
	return {ctor: 'AdventureLoc', _0: a};
};
var _user$project$KOLC$SelectLoc = function (a) {
	return {ctor: 'SelectLoc', _0: a};
};
var _user$project$KOLC$Rest = {ctor: 'Rest'};
var _user$project$KOLC$Rollover = {ctor: 'Rollover'};
var _user$project$KOLC$Equip = {ctor: 'Equip'};
var _user$project$KOLC$NewGame = {ctor: 'NewGame'};
var _user$project$KOLC$Town = {ctor: 'Town'};
var _user$project$KOLC$Forest = {ctor: 'Forest'};
var _user$project$KOLC$Beach = {ctor: 'Beach'};
var _user$project$KOLC$viewMode = function (model) {
	var _p7 = model.mode;
	if (_p7.ctor === 'Combat') {
		var _p8 = _p7._0;
		return A2(
				...
				_0: A2(
					...
					{ctor: '[]'},
					{
						...
						_0: _elm_lang$html$Html$text(
							A2(_elm_lang$core$Basics_ops['++'], 'Monster Name: ', _p8)),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
								...
								_0: A2(
									_elm_lang$html$Html$button,
									{
										...
										_0: _elm_lang$html$Html_Events$onClick(
											_user$project$KOLC$TurnDamage(
												_elm_lang$core$Result$Ok(3))),
										_1: {ctor: '[]'}
									},
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text('Taunt Tonald'),
										_1: {ctor: '[]'}
									}),
								_1: {
									ctor: '::',
									_0: A2(
										_elm_lang$html$Html$button,
										{
											ctor: '::',
											_0: _elm_lang$html$Html_Events$onClick(
												_user$project$KOLC$DealDamage(_p8)),
											_1: {ctor: '[]'}
										},
										{
											ctor: '::',
											_0: _elm_lang$html$Html$text('Hit it with your fists'),
											_1: {ctor: '[]'}
										}),
									_1: {
										ctor: '::',
										_0: A2(
											...
											{
												ctor: '::',
												_0: _elm_lang$html$Html$text('Run away'),
												_1: {ctor: '[]'}
											}),
										_1: {ctor: '[]'}
									}
					...
					{ctor: '[]'},
					{
						...
						_0: A2(
							_elm_lang$html$Html$img,
							{
								...
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html_Events$onClick(
										_user$project$KOLC$SelectLoc(_user$project$KOLC$Beach)),
									_1: {ctor: '[]'}
								}
							},
							{ctor: '[]'}),
						_1: {
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$src('/static/advs/img/place3.gif'),
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html_Events$onClick(
											_user$project$KOLC$SelectLoc(_user$project$KOLC$Forest)),
										_1: {ctor: '[]'}
									}
								},
								{ctor: '[]'}),
							_1: {
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$src('/static/advs/img/place2.gif'),
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html_Events$onClick(
												_user$project$KOLC$SelectLoc(_user$project$KOLC$Town)),
											_1: {ctor: '[]'}
										}
									},
									{ctor: '[]'}),
						...
						_0: A2(
							_elm_lang$html$Html$img,
							{
								...
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html_Events$onClick(
										_user$project$KOLC$AdventureLoc(_user$project$KOLC$Beach)),
									_1: {ctor: '[]'}
								}
							},
							{ctor: '[]'}),
						...
						_0: A2(
							_elm_lang$html$Html$img,
							{
								...
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html_Events$onClick(
										_user$project$KOLC$AdventureLoc(_user$project$KOLC$Forest)),
									_1: {ctor: '[]'}
								}
							},
							{ctor: '[]'}),
						...
						_0: A2(
							_elm_lang$html$Html$img,
							{
								...
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html_Events$onClick(
										_user$project$KOLC$AdventureLoc(_user$project$KOLC$Town)),
									_1: {ctor: '[]'}
								}
							},
							{ctor: '[]'}),
...
var _user$project$KOLC$Inventory = {ctor: 'Inventory'};
var _user$project$KOLC$Main = {ctor: 'Main'};
var _user$project$KOLC$initialModel = {
	equipped: false,
	allitems: {
		ctor: '::',
		_0: 'beans',
	...
	adventures: 40,
	mode: _user$project$KOLC$Noncombat(_user$project$KOLC$Main),
	currency: 0,
	hitpoints: 10
};
var _user$project$KOLC$update = F2(
	function (msg, model) {
		...
		switch (_p10.ctor) {
			case 'NewGame':
				return {ctor: '_Tuple2', _0: _user$project$KOLC$initialModel, _1: _elm_lang$core$Platform_Cmd$none};
			case 'Equip':
				return {
					ctor: '_Tuple2',
			...
			case 'Rollover':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							adventures: _user$project$KOLC$capAdventures(model.adventures + 40)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'Rest':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{adventures: model.adventures - 1, hitpoints: model.hitpoints + 10}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'SelectLoc':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							mode: _user$project$KOLC$Noncombat(_p10._0)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'AdventureLoc':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							...
							currency: _user$project$KOLC$capCurrency(model.currency + 5)
						}),
					_1: _user$project$KOLC$takeDamage(_p10._0)
				};
			case 'DealDamage':
				return _user$project$KOLC$isMonsterDead(model.mode) ? {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							mode: _user$project$KOLC$Noncombat(
								_user$project$KOLC$locFromMode(model.mode))
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				} : {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							mode: _user$project$KOLC$playerDoesDamage(model.mode)
						}),
					_1: A2(_user$project$KOLC$takeTurnDamage, _p10._0, 1)
				};
			case 'Damage':
				if (_p10._0.ctor === 'Ok') {
					var _p11 = _p10._0._0;
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								hitpoints: _user$project$KOLC$capHitpoints(model.hitpoints - _p11.damage),
								mode: A2(_user$project$KOLC$startFightWith, model.mode, _p11.name)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				} else {
					var _p12 = A2(_elm_lang$core$Debug$log, 'Oops!', _p10._0._0);
				...
				if (_p10._0.ctor === 'Ok') {
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								hitpoints: _user$project$KOLC$capHitpoints(model.hitpoints - _p10._0._0)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				} else {
					var _p13 = A2(_elm_lang$core$Debug$log, 'Oops TurnDamage failed', _p10._0._0);
					return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
				}
		}
	});
var _user$project$KOLC$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('char-pane'),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
					_0: _user$project$KOLC$viewCharacter(model),
					_1: {
						ctor: '::',
						_0: A2(
							_elm_lang$html$Html$p,
							{ctor: '[]'},
							{
								...
								_0: _elm_lang$html$Html$text(
									A2(
										_elm_lang$core$Basics_ops['++'],
										' Hitpoints: ',
										_elm_lang$core$Basics$toString(model.hitpoints))),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
								...
								{ctor: '[]'},
								{
									...
									_0: _elm_lang$html$Html$text(
										A2(
											_elm_lang$core$Basics_ops['++'],
											' Currency: ',
											_elm_lang$core$Basics$toString(model.currency))),
									_1: {ctor: '[]'}
								}),
							_1: {
								ctor: '::',
									...
									{ctor: '[]'},
									{
										...
										_0: _elm_lang$html$Html$text(
											A2(
												_elm_lang$core$Basics_ops['++'],
												' Adventures: ',
												_elm_lang$core$Basics$toString(model.adventures))),
										_1: {ctor: '[]'}
									}),
								_1: {ctor: '[]'}
							}
			...
			_1: {
				...
				_0: A2(
					_elm_lang$html$Html$div,
					{
						...
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('nav-pane'),
							_1: {ctor: '[]'}
						}
					},
					{
						...
						_0: A2(
							_elm_lang$html$Html$button,
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Events$onClick(
									_user$project$KOLC$SelectLoc(_user$project$KOLC$Main)),
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text('Main Map'),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
							_0: A2(
								_elm_lang$html$Html$button,
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Events$onClick(
										_user$project$KOLC$SelectLoc(_user$project$KOLC$Inventory)),
									_1: {ctor: '[]'}
								},
								{
									ctor: '::',
							...
							_1: {
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Events$onClick(_user$project$KOLC$Equip),
										_1: {ctor: '[]'}
									},
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text('Equip that Shit'),
										_1: {ctor: '[]'}
									}),
								_1: {
									ctor: '::',
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html_Events$onClick(_user$project$KOLC$Rollover),
											_1: {ctor: '[]'}
										},
										{
											ctor: '::',
											_0: _elm_lang$html$Html$text('New Day'),
											_1: {ctor: '[]'}
										}),
									_1: {
										ctor: '::',
										_0: A2(
											...
											{
												ctor: '::',
												_0: _elm_lang$html$Html_Events$onClick(_user$project$KOLC$Rest),
												_1: {ctor: '[]'}
											},
											{
												ctor: '::',
				...
				_1: {
					ctor: '::',
					_0: _user$project$KOLC$viewMode(model),
					_1: {ctor: '[]'}
				}
			}
		});
};
var _user$project$KOLC$main = _elm_lang$html$Html$program(
	{
		init: {ctor: '_Tuple2', _0: _user$project$KOLC$initialModel, _1: _elm_lang$core$Platform_Cmd$none},
		view: _user$project$KOLC$view,
		update: _user$project$KOLC$update,
...
var Elm = {};
Elm['KOLC'] = Elm['KOLC'] || {};
if (typeof _user$project$KOLC$main !== 'undefined') {
    _user$project$KOLC$main(Elm['KOLC'], 'KOLC', undefined);
}
