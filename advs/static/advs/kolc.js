			...
			A2(
				_elm_lang$core$Basics_ops['++'],
				{
					...
					_0: _evancz$elm_graphics$Collage$toForm(
						A3(_evancz$elm_graphics$Element$image, 60, 100, 'img/base.gif')),
					_1: {ctor: '[]'}
				},
				model.equipped ? {
					ctor: '::',
					_0: _evancz$elm_graphics$Collage$toForm(
						A3(_evancz$elm_graphics$Element$image, 60, 100, 'img/hat.gif')),
					_1: {ctor: '[]'}
				} : {ctor: '[]'})));
};
...
var _user$project$KOLC$takeDamage = A2(
	_elm_lang$http$Http$send,
	_user$project$KOLC$Damage,
	A2(_elm_lang$http$Http$get, _user$project$KOLC$damageUrl, _user$project$KOLC$decoderDamage));
			...
			return A2(
				...
				{ctor: '[]'},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$src('img/place1.gif'),
							_1: {
								ctor: '::',
					...
					_1: {
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$src('img/place3.gif'),
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html_Events$onClick(
						...
						_1: {
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$src('img/place2.gif'),
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html_Events$onClick(
		...
		switch (_p1.ctor) {
			...
			case 'AdventureLoc':
				return {
					...
					_1: _user$project$KOLC$takeDamage
				};
			default:
				if (_p1._0.ctor === 'Ok') {
					var _p2 = _p1._0._0;
