...
var _user$project$KOLC$viewMap = function (model) {
		...
		switch (_p1.ctor) {
			...
			case 'AdventureLoc':
				return {
					...
					_1: _user$project$KOLC$takeDamage(_p1._0)
				};
			default:
				if (_p1._0.ctor === 'Ok') {
					var _p2 = _p1._0._0;
					...
					var _p3 = A2(_elm_lang$core$Debug$log, 'Oops!', _p1._0._0);
	...
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_1: {
				...
				_1: {
					ctor: '::',
					_0: _user$project$KOLC$viewMap(model),
					_1: {
						ctor: '::',
						_0: A2(
							_elm_lang$html$Html$p,
...
if (typeof _user$project$KOLC$main !== 'undefined') {
    _user$project$KOLC$main(Elm['KOLC'], 'KOLC', {"types":{"message":"KOLC.Msg","aliases":{"KOLC.AdventureResult":{"type":"{ damage : Int, name : String, location : String }","args":[]},"Http.Response":{"type":"{ url : String , status : { code : Int, message : String } , headers : Dict.Dict String String , body : body }","args":["body"]}},"unions":{"Dict.NColor":{"tags":{"Black":[],"BBlack":[],"Red":[],"NBlack":[]},"args":[]},"KOLC.Loc":{"tags":{"Town":[],"Beach":[],"Main":[],"Forest":[]},"args":[]},"Result.Result":{"tags":{"Err":["error"],"Ok":["value"]},"args":["error","value"]},"Http.Error":{"tags":{"Timeout":[],"BadStatus":["Http.Response String"],"BadPayload":["String","Http.Response String"],"BadUrl":["String"],"NetworkError":[]},"args":[]},"KOLC.Msg":{"tags":{"Equip":[],"Rest":[],"Rollover":[],"NewGame":[],"SelectLoc":["KOLC.Loc"],"Damage":["Result.Result Http.Error KOLC.AdventureResult"],"AdventureLoc":["KOLC.Loc"]},"args":[]},"Dict.LeafColor":{"tags":{"LBlack":[],"LBBlack":[]},"args":[]},"Dict.Dict":{"tags":{"RBNode_elm_builtin":["Dict.NColor","k","v","Dict.Dict k v","Dict.Dict k v"],"RBEmpty_elm_builtin":["Dict.LeafColor"]},"args":["k","v"]}}},"versions":{"elm":"0.18.0"}});
}
